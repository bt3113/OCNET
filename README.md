...
- [Production architecture](docs/production-architecture.md) · [research notes](docs/technical-research-notes.md) · [progress and open gaps](docs/implementation-progress.md) · **[Release handover: what is live and what is pending](docs/release-handover.md)**
