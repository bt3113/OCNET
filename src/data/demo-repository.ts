...
/**
 * Browser-storage repository for the public demo. Loaded on demand (see getRepository),
 * so the demo catalogue never ships in the connected-mode startup bundle.
 */
