...
for (const width of [1440, 1280, 1024, 768, 430, 390, 360])
  test(`responsive layout and screenshot at ${width}px`, async ({ page }) => {
    ...
    for (const path of [
      ...
      "/use-cases/product-video-website",
      "/use-cases",
      "/use-cases/chase-overdue-invoices",
      "/builds/service-enquiry-booking-system?tab=how-it-works",
      "/solution-providers",
      "/solution-providers/northstar-studio",
      "/technology-vendors/xai",
      "/search?q=invoice",
      "/admin/use-cases",
      "/creator",
      "/app/projects/new",
...
for (const path of [
  ...
  "/builds/ai-dental-receptionist",
  "/creator/builds/new",
  "/solution-providers/alex-chen",
  "/solution-providers",
  "/use-cases",
  "/use-cases/chase-overdue-invoices",
  "/use-cases/handle-customer-inquiries-with-voice-agents?tab=sources",
  "/builds/service-enquiry-booking-system?tab=proof",
  "/technology-vendors/xai",
  "/search?q=invoice",
  "/admin/use-cases",
  "/creator",
